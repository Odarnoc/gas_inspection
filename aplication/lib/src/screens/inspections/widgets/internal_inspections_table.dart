...
class InternalInspectionsTable extends StatelessWidget {
  const InternalInspectionsTable({
    super.key,
      ...
      child: Card(
        ...
        child: Column(
          children: [
            ...
            Text(
              S.of(context).lInternalInspections.toUpperCase(),
  ...
  List<Widget> _dataRows(BuildContext context) {
    ...
    return inspectionsController.internalInspections

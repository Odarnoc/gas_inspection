...
class InstalationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<InstalationsController>.value(
      value: InstalationsController(),
        ...
        builder: (context, instalationsController, child) => Scaffold(
            ...
            actions: [
              PopupMenuButton(
                ...
                itemBuilder: (ctx) => [
                  PopupMenuItem(
                    onTap: () {
                      instalationsController.loadRequestPetitions();
                    },
                    child: Row(
                      children: [
                        const Icon(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                InstalationsTable(
                    instalationsController: instalationsController),
                ReasignedInstalationsTable(
                    instalationsController: instalationsController),
              ],
            ),
          ),
